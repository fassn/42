...
<body>
    <div>
        <div class="topnav">
            ...
            <a class="active" href="accessoires.php">Accessoires</a>
        ...
        <div class="tab">
            <button class="tablinks" onclick="openSubcat(event, 'Tous')" id="defaultOpen">Tous les accessoires</button>
            <?php
            if ($result = mysqli_query($link, "SELECT DISTINCT `subcat` FROM `products` WHERE cat= 'Accessoires'")){
        ...
        <div id="Tous" class="tabcontent"> 
            <div class="element">
                <?php
                if ($data = mysqli_query($link, "SELECT * FROM `products` WHERE cat= 'Accessoires'")){
        ...
        foreach ($subcats as $subcat) {?>
            <div id="<?php echo $subcat?>" class="tabcontent">
                <div class="element">
                    <?php
                    if ($result = mysqli_query($link, "SELECT * FROM `products` WHERE cat= 'Accessoires' AND subcat IN ('".$subcat."')")){
                        while ($row = mysqli_fetch_assoc($result)){?>
                            <div class="card">
